...
<body>
  ...
  <form method="POST">
    <input class="input1" type="submit" name="sort_by_name" value="Сортировка по имени" /><br>
    <input class="input1" type="submit" name="sort_by_medals" value="Сортировка по медалям" /><br>
    <input class="input1" type="submit" name="sort_by_country" value="Сортировка по стране" /><br>
</form>
